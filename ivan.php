...
<head>
	...
	<title>Absence manager - Iván Díaz Miragaya</title>
...
<body>
    ...
    <?php
        ...
        $fASO=file_get_contents('ivan/ASOi.txt');
        $fEIE=file_get_contents('ivan/EIEi.txt');
        $fIAW=file_get_contents('ivan/IAWi.txt');
        $fSXBD=file_get_contents('ivan/SXBDi.txt');
        $fSR=file_get_contents('ivan/SRi.txt');
        $fSA=file_get_contents('ivan/SAi.txt');
        ...
        #Compueba que se pulso el boton de ASO
           if (isset($_GET['ASO'])) {
               $fASO++;
               file_put_contents('ivan/ASOi.txt', $fASO);
               #recarga pagina
           ...
           if (isset($_GET['EIE'])) {
               $fEIE++;
               file_put_contents('ivan/EIEi.txt', $fEIE);
               #recarga pagina
                header("Location: ivan.php");
            }
           ...
           if (isset($_GET['IAW'])) {
               $fIAW++;
               file_put_contents('ivan/IAWi.txt', $fIAW);
               #recarga pagina
                header("Location: ivan.php");
            }
           ...
           if (isset($_GET['SXBD'])) {
               $fSXBD++;
               file_put_contents('ivan/SXBDi.txt', $fSXBD);
               #recarga pagina
                header("Location: ivan.php");
            }
           ...
           if (isset($_GET['SR'])) {
               $fSR++;
               file_put_contents('ivan/SRi.txt', $fSR);
               #recarga pagina
                header("Location: ivan.php");
            }
           ...
           if (isset($_GET['SA'])) {
               $fSA++;
               file_put_contents('ivan/SAi.txt', $fSA);
               #recarga pagina
                header("Location: ivan.php");
            }
